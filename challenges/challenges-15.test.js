...
let biggerThanLuke = (arr) => {
  // let person = arr.filter(i => i.name === 'Luke Skywalker');
  // let massOfPerson = person.mass;
  // let nameList = arr.filter(i => parseInt(i.mass) > parseInt(massOfPerson));
  // let actualName = nameList.map(i => i.name);
  // let result = actualName.join(" - ");
  // return result;
...
const sortBy = (property, arr) => {
  // let a = arr.sort(function(a, b){return a[property] - b[property]});
  // return a;
  return arr.sort(
    (a, b) => {
